...
public class TestDragonModel extends HierarchicalModel<DragonEntity> {
    ...
    public TestDragonModel(ModelPart root) {
        ...
        this.neck_base = root.getChild("neck_base");
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition right_wing = partdefinition.addOrReplaceChild("right_wing", CubeListBuilder.create().texOffs(63, 34).mirror().addBox(-35.0F, -1.0F, 3.0F, 36.0F, 0.0F, 21.0F, new CubeDeformation(0.0F)).mirror(false)
                ...
                .texOffs(61, 123).addBox(-35.0F, 7.0F, -6.0F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(-10.0F, -13.0F, -13.0F));
        ...
        PartDefinition neck_base = partdefinition.addOrReplaceChild("neck_base", CubeListBuilder.create().texOffs(110, 137).addBox(-6.0F, -6.0F, -11.0F, 12.0F, 14.0F, 11.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -8.0F, -21.0F));
        ...
        PartDefinition jaw = head.addOrReplaceChild("jaw", CubeListBuilder.create().texOffs(140, 73).addBox(-6.0F, 0.0F, -10.0F, 12.0F, 4.0F, 12.0F, new CubeDeformation(0.075F))
                ...
                .texOffs(0, 0).mirror().addBox(-6.0F, 0.0F, -10.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.08F)).mirror(false)
                .texOffs(0, 0).addBox(4.0F, 0.0F, -10.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.08F))
        ...
        PartDefinition left_wing = partdefinition.addOrReplaceChild("left_wing", CubeListBuilder.create().texOffs(0, 111).addBox(0.0F, -3.0F, -3.0F, 35.0F, 6.0F, 6.0F, new CubeDeformation(0.0F))
                ...
                .texOffs(61, 123).addBox(30.0F, 7.0F, -6.0F, 5.0F, 6.0F, 5.0F, new CubeDeformation(0.0F)), PartPose.offset(10.0F, -13.0F, -13.0F));
        ...
        PartDefinition tail = partdefinition.addOrReplaceChild("tail", CubeListBuilder.create().texOffs(63, 118).addBox(-5.0F, -5.0F, -2.0F, 10.0F, 11.0F, 19.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, -8.0F, 23.0F));
        ...
        PartDefinition right_leg = partdefinition.addOrReplaceChild("right_leg", CubeListBuilder.create().texOffs(0, 123).addBox(-5.0F, -7.0F, -7.0F, 10.0F, 21.0F, 14.0F, new CubeDeformation(0.0F)), PartPose.offset(-12.0F, -4.0F, 14.0F));
        ...
        PartDefinition left_leg = partdefinition.addOrReplaceChild("left_leg", CubeListBuilder.create().texOffs(0, 123).mirror().addBox(-5.0F, -7.0F, -7.0F, 10.0F, 21.0F, 14.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(12.0F, -4.0F, 14.0F));
    ...
    public void setupAnim(DragonEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        entity.testAnimationState.startIfStopped(entity.tickCount);
